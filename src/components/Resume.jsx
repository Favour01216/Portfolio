  ...
  const educationDetails = [
    {
      ...
      place: "The University of Toronto continuous studies, Toronto, ON",
  ...
  const experienceDetails = [
    {
      ...
      place: "University of Toronto Continous Studies",
      desc: "Completed an intensive, full-time coding Bootcamp program, gaining practical experience in a variety of programming languages and technologies including HTML, CSS, and JavaScript. Developed and presented a final project, showcasing the ability to design and build a functional web application using learned skills and knowledge. Participated in group projects and pair programming exercises, improving teamwork and collaboration skills",
    },
    {
      yearRange: "2021",
